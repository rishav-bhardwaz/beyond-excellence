...
import crs3 from '../../public/images/crs3.jpg';
...
const loginPage = () => {
 ...
 return (
    ...
    <div className="w-[90%] px-[20px] py-[0px] -mt-28 xl:mt-0 xl:py-0  xl:px-[70px]">
        ...
        Punjabi Proficiency</div>
<div className="w-[80vw] xl:w-[500px] ml-4 text-[16px] text-black"> Duration -<span className="w-[80vw] xl:w-[500px] ml-4 text-[15px] text-[#505050]">5 Months </span></div>
<div className="w-[80vw] xl:w-[500px] ml-4 text-[15px] xl:my-4 text-[#505050]">Take your Punjabi language skills to the next level with our advanced course.
</div>
...
<div className="w-[90vw] xl:w-[400px] flex flex-row items-center justify-between pt-6">
    ...
    <div className=" w-[100%]">
        <img className='w-[100%] h-[100%]' src={crs3} alt="" />
    </div>
    </div>
