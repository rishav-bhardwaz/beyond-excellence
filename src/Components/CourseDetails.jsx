...
import crs1 from '../../public/images/crs1.jpg';
...
const loginPage = () => {
 ...
 return (
    ...
    <div className="w-[90%] px-[20px] py-[0px] -mt-28 xl:mt-0 xl:py-0  xl:px-[70px]">
        ...
        Mastering Malayalam</div>
<div className="w-[80vw] xl:w-[500px] ml-4 text-[16px] text-black"> Duration -<span className="w-[80vw] xl:w-[500px] ml-4 text-[15px] text-[#505050]">10 Weeks </span></div>
<div className="w-[80vw] xl:w-[500px] ml-4 text-[15px] xl:my-4 text-[#505050]">Learn to speak, read, and write Malayalam fluently with our comprehensive course.
</div>

<div className="w-[80vw] xl:w-[500px] ml-4 text-[16px] text-black"> Price -<span className="w-[80vw] xl:w-[500px] ml-4 text-[15px] text-[#505050]">&#8377; 999 </span></div>
...
<div className="w-[90vw] xl:w-[400px] flex flex-row items-center justify-between pt-6">
    ...
    <div className=" w-[100%]">
        <img className='w-[100%] h-[100%]' src={crs1} alt="" />
    </div>
    </div>
